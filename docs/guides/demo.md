...
These screenshots show the actual embedded dashboard with synthetic demo data.

![Overview with populated request and spend totals](../images/demo-overview.png)

![Usage with a daily token chart and accounting table](../images/demo-usage.png)
