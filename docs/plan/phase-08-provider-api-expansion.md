...
Status: in progress. The broader provider preset catalog, deterministic metadata checks, gateway-owned stored/background Response lifecycle, and native OpenAI image edit/variation and audio transcription/translation operations are implemented; live certification and larger resource/auth work remain open. [Plan index](README.md)
