...
Additional verification (2026-09-24): terminal media output-size and encryption failures retain provider-reported cost in authoritative settlement and the daily usage projection while discarding output. The media and usage package tests passed with and without the race detector.
