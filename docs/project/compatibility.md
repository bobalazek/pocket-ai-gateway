...
| OpenAI Responses | Stored JSON, durable background lifecycle, stateless JSON/SSE, native response compaction, and gateway-owned Conversation resources | Go fixtures and OpenAI SDK 7.15.0 integration |
