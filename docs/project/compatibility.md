...
| OpenAI Responses | Stored JSON, durable background lifecycle, stateless JSON/SSE, native response compaction, Conversation resources, and atomic synchronous/background attachment | Go fixtures and OpenAI SDK 7.15.0 integration |
