...
- [ ] Supply a disposable S3-compatible bucket/endpoint and credentials — Owner: project owner — Unblocks: off-host upload/download/restore certification. Local encrypted archive and S3 contract tests are already available.
