...
| --- | --- | --- | --- | --- | --- |
| OpenAI | `https://api.openai.com/v1` | OpenAI | Chat, Responses, input-token counting, embeddings, moderations, image generation | 2026-09-15 | Credentials required |
...
- OpenAI Chat, stateless Responses, input-token counting, embeddings, moderations, non-streaming image generation, and streaming against local upstreams;
