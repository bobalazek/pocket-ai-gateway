...
- [x] A [disposable demo](../guides/demo.md) populates users, models, keys, priced usage, and seven days of history; 14 reviewed screenshots cover analytics, requests, configuration, and administration. It cannot seed an existing data directory.
