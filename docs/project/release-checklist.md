...
- [x] A [disposable demo](../guides/demo.md) populates users, models, keys, priced usage, and seven days of history; reviewed overview, usage, and model-routing screenshots are included. It cannot seed an existing data directory.
