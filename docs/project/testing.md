...
| Compatibility | Pinned official client fixtures against mock upstreams | OpenAI, Anthropic and Google clients across every supported client/provider combination |
