...
| POST /api/anthropic/v1/messages | Anthropic message/content blocks, stop reasons, usage, typed content stream with a stable public model alias, bounded native JSON/SSE basic or dynamic `web_search_20250305`/`web_search_20260209` with `messages:web_search`, and `web_fetch_20250910`/`web_fetch_20260209` with `messages:web_fetch` |
