...
var presets = []Preset{
	{ID: "openai", Label: "OpenAI", Adapter: "openai", BaseURL: "https://api.openai.com/v1", CredentialRequired: true, Operations: []string{"chat/completions", "responses", "responses/compact", "responses/input_tokens", "embeddings", "moderations", "images/generations"}, DocumentationURL: "https://developers.openai.com/api/reference/overview", ReviewedAt: "2026-09-15"},
...
func PresetSupportsCapabilities(presetID string, capabilities []string) bool {
	for _, capability := range capabilities {
		supported := false
		for _, operation := range []string{"chat/completions", "messages", "generateContent", "responses", "responses/compact", "responses/input_tokens", "embeddings", "embedContent", "batchEmbedContents", "moderations", "images/generations", "messages/count_tokens", "countTokens"} {
