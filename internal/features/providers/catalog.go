...
var presets = []Preset{
	...
	{ID: "mistral", Label: "Mistral AI", Adapter: "openai_compatible", BaseURL: "https://api.mistral.ai/v1", CredentialRequired: true, Operations: []string{"chat/completions", "embeddings"}, DocumentationURL: "https://docs.mistral.ai/api", ReviewedAt: "2026-09-16"},
