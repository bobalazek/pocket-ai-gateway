...
var presets = []Preset{
	...
	{ID: "codiv", Label: "Codiv (OpenJev, Laya, Verdict)", Adapter: "openai_compatible", BaseURL: "https://api.codiv.ai/v1", CredentialRequired: true, Operations: []string{"systemone"}, DocumentationURL: "https://codiv.ai", ReviewedAt: "2026-09-25"},
	{ID: "vercel-typesafe", Label: "Vercel AI Gateway (Jev)", Adapter: "openai_compatible", BaseURL: "https://ai-gateway.vercel.sh/typesafe/v1", CredentialRequired: true, Operations: []string{"systemone"}, DocumentationURL: "https://vercel.com/docs/ai-gateway/sdks-and-apis/typesafe", ReviewedAt: "2026-09-25"},
	{ID: "kev", Label: "Kev (self-hosted)", Adapter: "openai_compatible", BaseURL: "http://127.0.0.1:8009/v1", PrivateNetwork: true, Authentication: "Optional bearer key set with KEV_API_KEY", Operations: []string{"systemone"}, DocumentationURL: "https://github.com/jaredpalmer/kev", ReviewedAt: "2026-09-25"},
	{ID: "clm", Label: "CLM (self-hosted)", Adapter: "openai_compatible", BaseURL: "http://127.0.0.1:8700/v1", PrivateNetwork: true, Authentication: "Optional bearer key set with CLM_API_KEY", Operations: []string{"systemone"}, DocumentationURL: "https://github.com/Contrastive-LM/CLM", ReviewedAt: "2026-09-25"},
	{ID: "openjev", Label: "OpenJev (self-hosted)", Adapter: "openai_compatible", BaseURLRequired: true, BaseURLExample: "http://127.0.0.1:8081/v1", PrivateNetwork: true, Authentication: "Optional bearer key set with OPENJEV_API_KEY or SHIM_TOKEN", Operations: []string{"systemone"}, DocumentationURL: "https://github.com/razorback16/openjev", ReviewedAt: "2026-09-25"},
