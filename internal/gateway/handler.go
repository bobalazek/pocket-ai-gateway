...
func (handler *Handler) Register(mux *http.ServeMux) {
	...
	mux.HandleFunc("POST /api/openai/v1/vector_stores/{vector_store_id}/file_batches", handler.createVectorStoreFileBatch)
	mux.HandleFunc("GET /api/openai/v1/vector_stores/{vector_store_id}/file_batches/{batch_id}", handler.getVectorStoreFileBatch)
	mux.HandleFunc("POST /api/openai/v1/vector_stores/{vector_store_id}/file_batches/{batch_id}/cancel", handler.cancelVectorStoreFileBatch)
	mux.HandleFunc("GET /api/openai/v1/vector_stores/{vector_store_id}/file_batches/{batch_id}/files", handler.listVectorStoreFileBatchFiles)
