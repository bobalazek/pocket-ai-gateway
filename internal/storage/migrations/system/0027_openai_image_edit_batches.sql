CREATE TABLE openai_batches_v27 (
    id TEXT PRIMARY KEY,
    owner_user_id TEXT NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    key_id TEXT NOT NULL REFERENCES api_keys(id) ON DELETE CASCADE,
    input_file_id TEXT NOT NULL CHECK (length(input_file_id) BETWEEN 1 AND 128),
    endpoint TEXT NOT NULL CHECK (endpoint IN ('/v1/responses', '/v1/chat/completions', '/v1/embeddings', '/v1/moderations', '/v1/images/generations', '/v1/images/edits')),
...
CREATE TABLE openai_batch_items_v27 (
    batch_id TEXT NOT NULL REFERENCES openai_batches_v27(id) ON DELETE CASCADE,
...
INSERT INTO openai_batches_v27 SELECT * FROM openai_batches;
INSERT INTO openai_batch_items_v27 SELECT * FROM openai_batch_items;

DROP TABLE openai_batch_items;
DROP TABLE openai_batches;
ALTER TABLE openai_batches_v27 RENAME TO openai_batches;
ALTER TABLE openai_batch_items_v27 RENAME TO openai_batch_items;
