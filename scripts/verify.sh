...
if [[ "${POCKET_AI_GATEWAY_QUICK_VERIFY:-}" != "1" ]]; then
  go test -race ./internal/storage ./internal/server ./internal/app ./internal/selfupdate ./internal/features/auth ./internal/features/users ./internal/features/keys ./internal/features/usage ./internal/features/providers ./internal/features/operations ./internal/gateway ./internal/protocol
