...
import type { GatewayInferenceScope, GatewaySession, GatewayUser } from "@/features/auth/types/auth.types";
...
export const authClient = {
  ...
  session: (signal?: AbortSignal) => gatewayTransport.request<{ user: GatewayUser; session: GatewaySession; inference_scopes: GatewayInferenceScope[] }>("/api/v1/auth/session", { signal, redirectOnUnauthorized: false }),
