    ...
    <AppShell active="Providers">
      <main id="main-content" className="content management-page">
        <header className="page-header">
          <div><p className="context">Provider boundary</p><h1>Providers</h1><p className="lede">One connection shares an endpoint and credential across its upstream models. Each model has its own ID and capabilities.</p></div>
        </header>
