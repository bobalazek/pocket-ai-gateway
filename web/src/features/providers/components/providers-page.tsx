      ...
      <main id="main-content" className="content management-page">
        ...
        <section className="section-block">
          ...
          <div className="resource-list">
            {model.items.map((item) => <ProviderCard key={item.id} item={item} busy={model.busy} onToggle={model.toggle} onCredential={model.credential} onAddModel={model.addModel} script={model.scripts[item.id]} onLoadScript={model.loadScript} onSaveScript={model.saveScript} onRemoveScript={model.removeScript} />)}
          </div>
        </section>
