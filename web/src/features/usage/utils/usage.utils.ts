...
export const emptyUsage: UsageSummary = { from: "", to: "", requests: 0, attempts: 0, input_tokens: 0, output_tokens: 0, cache_creation_input_tokens: 0, cache_read_input_tokens: 0, cache_creation_5m_input_tokens: 0, cache_creation_1h_input_tokens: 0, known_cost_usd: "0", estimated_cost_usd: "0", as_recorded_cost_usd: "0", restatement_delta_usd: "0", unknown_attempts: 0, points: [] };
