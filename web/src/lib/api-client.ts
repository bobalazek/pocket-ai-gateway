...
export type ProviderPreset = { id: string; label: string; adapter: ProviderConnection["adapter"]; base_url: string; credential_required: boolean; private_network: boolean };
